...
const columns = [
    ...
    {
        header: "Classname", assessor: "classname"
    },
    {
        header: "Capacity", assessor: "capacity",className: "hidden md:table-cell"
    },
    {
        header: "Grade", assessor: "grade", className: "hidden md:table-cell"
    },
    {
        header: "Supervisor", assessor: "supervisor", className: "hidden md:table-cell"
    },
    {
