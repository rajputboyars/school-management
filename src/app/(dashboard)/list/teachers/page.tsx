...
const columns = [
    ...
    {
        header: "Teacher Id", assessor: "teacherId", className: "hidden md:table-cell"
    },
    {
        header: "Teacher Name", assessor: "teacherName", className: "hidden md:table-cell"
    },
    {
    ...
    {
        header: "Subjects", assessor: "subjects", className: "hidden md:table-cell"
    },
    {
        header: "Classes", assessor: "classes", className: "hidden lg:table-cell"
    },
    {
